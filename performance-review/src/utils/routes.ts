...
export const ROLE_REDIRECTS: Record<UserRole, string> = {
  hr_admin: PROTECTED_ROUTES.DASHBOARD,
  ...
  switch (role) {
    case 'hr_admin':
      return [
        ...
        { path: PROTECTED_ROUTES.ADMIN_OBJECTIVES, label: 'Objectives', icon: 'flag' },
        ...
        { path: PROTECTED_ROUTES.ADMIN_REPORTS, label: 'Reports', icon: 'document' },
        { path: PROTECTED_ROUTES.FEEDBACK, label: 'Feedback', icon: 'chat' },
        { path: PROTECTED_ROUTES.AI, label: 'AI Insights', icon: 'sparkles' },
    ...
    case 'manager':
      return [
        { path: PROTECTED_ROUTES.DASHBOARD, label: 'Dashboard', icon: 'home' },
        { path: PROTECTED_ROUTES.OBJECTIVES, label: 'Objectives', icon: 'flag' },
    ...
    case 'individual_contributor':
      return [
        { path: PROTECTED_ROUTES.DASHBOARD, label: 'Dashboard', icon: 'home' },
        { path: PROTECTED_ROUTES.GOALS, label: 'My Goals', icon: 'flag' },
